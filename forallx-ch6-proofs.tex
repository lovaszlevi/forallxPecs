...
Mivel $\script{A}\eif\script{B}$ is a \emph{anyagi feltétel}, egyenértékű $\enot\script{A}\eor\script{B}$ -vel. Egy további helyettesítő szabály rögzíti ezt az egyenértékűséget. Az MC szabályt rövidítjük az „anyagi feltétel” kifejezésre. Ez kétféle lehet:
...
Most fontolja meg ezt az állítást: $\enot(P \eif Q)$, \therefore\ $P \eand \enot Q$
...
Mint mindig, ezt az állítást csak az alapszabályok segítségével tudtuk bizonyítani. A csereszabályokkal azonban a bizonyítás sokkal egyszerűbb:
...
A végső csereszabály rögzíti a feltételes és a kétfeltételes feltétel közötti kapcsolatot. Ezt a szabályt kétfeltételes cserének nevezzük és {\eiff}{ex} -nek rövidítjük.
...
\section{A mennyiségi meghatározókra vonatkozó szabályok}
...
A QL bizonyításaihoz az SL összes alapszabályát, valamint négy új alapszabályt használunk: a bevezetési és a megszüntetési szabályokat is az egyes mennyiségi meghatározókra.
...
Mivel az SL összes származtatott szabálya az alapszabályokból származik, QL-ben is megmaradnak. Felveszünk egy újabb származtatott szabályt, egy helyettesítő szabályt, melyet kvantitatív tagadásnak hívnak.
...
A mennyiségi meghatározókra vonatkozó szabályok rövid ismertetése érdekében, szükségünk van egy módra a számszerűsített mondatok és azok példányai közötti kapcsolat megjelölésére. Például a $Pa$ a $\forall x Px$ általános igény különleges példánya.
